...
def problem():
    with tf.name_scope('Optimizee_loss'):
        ...
        x = Dense(n_hidden1,activation='sigmoid',kernel_initializer='random_uniform',bias_initializer='random_uniform')(inputs)
        predictions = Dense(n_output,activation='sigmoid',kernel_initializer='random_uniform',bias_initializer='random_uniform')(x)
...
def metaopti(prob):
    opt_var = tf.trainable_variables()
